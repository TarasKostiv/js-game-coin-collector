...
var die = false;
var currentScore = 0;
var winningScore = 115;
var dieScore = -30;
var isStarPick = false;
...
function addItems() {
  ...
  createItem(10, 150, "coin");
  // createItem(375, 80, "poison");
  createItem(370, 500, "poison");
  createItem(100, 375, "poison");
  createItem(600, 250, "poison");
  createItem(300, 185, "poison");
  createItem(125, 40, "star");
  createItem(460, 130, "jumpBoost");
}
...
function addPlatforms() {
  ...
  platforms.create(250, 130, "platform");
  ...
  platforms.create(100, 80, "platform2");
...
function itemHandler(player, item) {
  ...
  if (item.key === "coin") {
    ...
    currentScore = currentScore + 25;
    isStarPick = true;
  } else if (item.key === "jumpBoost") {
    player.body.velocity.y = -400;
  }
  if (currentScore >= winningScore && isStarPick === true) {
    createBadge();
  }
  if (currentScore <= dieScore) {
    die = true;
  }
}
...
window.onload = function() {
  ...
  function preload() {
    ...
    game.load.spritesheet("jumpBoost", "jumpBooster.png", 32, 32);
  }
  ...
  function create() {
    ...
    dieMessage = game.add.text(game.world.centerX, 275, "", {
      font: "bold 48px Arial",
      fill: "white"
    });
    dieMessage.anchor.setTo(0.5, 1);
  }
